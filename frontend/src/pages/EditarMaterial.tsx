...
const Editar = () => {
    ...
    const handleSave = async () => {
        const updatedData = {
            ...
            estado_publicacion_material: condicion,
            ...
            latitud_publicacion_material: coordenadasSeleccionadas?.lat,
            longitud_publicacion_material: coordenadasSeleccionadas?.lng,
        };
        ...
        try {
            ...
            navigate("/publicProfile"); // Cambié history.push a navigate
        } catch (error) {
            console.error("Error:", error);
