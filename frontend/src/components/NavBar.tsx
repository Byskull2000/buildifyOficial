                    ...
                    >
                        <div className="relative mt-3 md:hidden">
                            ...
                            <input
                                type="text"
                                id="search-navbar"
                                className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 md:hover:text-blue-700"
                                placeholder="Search..."
                            />
                        </div>
