...
class Pedido(db.Model):
    ...
    nombre_destinatario_pedido = db.Column(db.String(30), nullable=False)
    descrip_direc_entrega_pedido = db.Column(db.String(255), nullable=False)
    telefono_ref_pedido = db.Column(db.String(20), nullable=False)
    latitud_entrega_pedido = db.Column(db.String(50), nullable=False)
    longitud_entrega_pedido = db.Column(db.String(50), nullable=False)
