...
class Usuario(db.Model):
    ...
    def __init__(self, nombre_usuario=None, correo_electronico=None, numero_telefono=None, contrasenia=None, ultimo_login=None, estado_usuario=None, zona_trabajo=None, imagen_perfil=None, fecha_creacion=None):
